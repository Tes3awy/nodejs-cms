    ...
    $.extend($.summernote.plugins, {
        ...
        'rtl': function(context) {
            ...
            context.memo('button.rtl', function() {
                ...
                var button = ui.button({
                    contents: '<i class="fas fa-paragraph"><i class="fas fa-caret-left">',
                    title: 'Change text direction to the right',
                    click: function() {
        ...
        'ltr': function(context) {
            ...
            context.memo('button.ltr', function() {
                // create button
                var button = ui.button({
                    contents: '<i class="fas fa-caret-right"><i class="fas fa-paragraph">',
                    title: 'Change text direction to the left',
                    click: function() {
                        function clearSelection() {
                            if (document.selection) {
                                document.selection.empty();
